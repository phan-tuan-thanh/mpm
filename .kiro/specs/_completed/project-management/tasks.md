...
- [x] 3. Backend — ProjectModule
  ...
  - [x] 3.2 Implement Project Service
  ...
  - [x] 3.3 Implement Project Controller
  ...
  - [x]* 3.5 Viết property tests cho Project Service
...
- [x] 4. Backend — ProjectMemberModule
  - [x] 4.1 Implement Project Member Service
  ...
  - [x] 4.2 Implement Project Member Controller
  ...
  - [x]* 4.4 Viết property tests cho Project Member Service
...
- [x] 10. Frontend — Project List Page
  - [x] 10.1 Implement ProjectListPage
...
- [x] 11. Frontend — Create Project Page
  - [x] 11.1 Implement CreateProjectPage
