...
- [ ] 1. Database migrations
  - [ ] 1.1 Migration 1: `AddProjectSettingsColumns`
  ...
  - [ ] 1.2 Migration 2: `MigrateTaskStateToFK`
...
- [ ] 3. Checkpoint — Verify migrations và types
...
- [ ] 4. Backend — Project State Service và Controller
  - [ ] 4.1 Tạo ProjectState entity
  ...
  - [ ] 4.2 Implement Project State Service
  ...
  - [ ] 4.3 Implement Project State Controller
...
- [ ] 5. Backend — Estimate Config Service và Controller
  - [ ] 5.1 Tạo ProjectEstimateConfig entity
    - `apps/backend/src/project/entities/project-estimate-config.entity.ts`
    - `@OneToOne(() => Project)`, `@Column({ type: 'jsonb' }) values`
    - _Requirements: 5.1_

  - [ ] 5.2 Implement Estimate Config Service
  ...
  - [ ] 5.3 Implement Estimate Config Controller
...
- [ ] 6. Backend — Cập nhật Project Service (General + Cover + Network + Features)
  - [ ] 6.1 Cập nhật Project Service
  ...
  - [ ] 6.2 Implement Cover Image Service
  ...
  - [ ] 6.3 Implement Cover Image Controller
  ...
  - [ ] 6.4 Implement Features Controller
    - `PATCH /api/projects/:projectId/features` — @ProjectRoles('Scrum_Master')
    - _Requirements: 6.2_

  - [ ] 6.5 Cập nhật Project findAll và findById responses
...
- [ ] 7. Cập nhật Task Entity và Task Service (sau khi migrate schema)
...
- [ ] 8. Wire các modules mới vào AppModule
...
- [ ] 10. Checkpoint — Verify backend hoàn toàn
...
- [ ] 11. Frontend — Cập nhật Project Store và Services
  - [ ] 11.1 Cập nhật Project Angular Service
  ...
  - [ ] 11.2 Cập nhật Project Signal Store
...
- [ ] 12. Frontend — Cập nhật Project List Page
...
- [ ] 13. Frontend — Cập nhật Create Project Form
...
- [ ] 14. Frontend — Cập nhật Project Settings Page (thêm tabs mới)

  - [ ] 14.1 Cập nhật General Tab
...
- [ ] 15. Frontend — Cập nhật Sidebar (emoji + feature-aware navigation)
...
- [ ] 16. Frontend — Feature Guard và Route Protection
...
- [ ] 17. Frontend — Cập nhật Task Store và Backlog (state-aware)
...
- [ ] 18. Checkpoint — Verify toàn bộ frontend
...
|-----------|-----------|---------|-----------|
| 1 (Migrations) | | | todo |
| 2–3 (Types + Checkpoint) | | | todo |
| 4 (State Service + Controller) | | | todo |
| 5 (Estimate Config) | | | todo |
| 6 (Project Service updates) | | | todo |
| 7 (Task Entity/Service update) | | | todo |
| 8–10 (Wire + Tests + Checkpoint) | | | todo |
| 11–12 (Angular Store + List) | | | todo |
| 13 (Create Project form) | | | todo |
| 14 (Settings tabs: States/Estimates/Features) | | | todo |
| 15–16 (Sidebar + Guards) | | | todo |
| 17 (Task Store updates) | | | todo |
| 18–19 (Checkpoints) | | | todo |
