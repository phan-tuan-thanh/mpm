...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      Task, Label, TaskAttachment, TaskLink, TaskRelation, TaskActivity, ProjectMember, User,
    ]),
  ...
  controllers: [
    TaskController, TaskQueryController, LabelController, AttachmentController, LinkController, RelationController, CommentController,
  ],
  providers: [
    TaskService, TaskQueryService, TaskCreateService, TaskUpdateService, TaskDeleteService, TaskOrderService,
    ActivityService, LabelService, AttachmentService, LinkService, RelationService,
  ],
